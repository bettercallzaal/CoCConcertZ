...
const EVENTS: EventSeed[] = [
  {
    ...
    recap: {
      ...
      videos: [
        { title: "AttaBotty Intro", youtubeId: "-ggYAdu4KRE", artist: "AttaBotty" },
        { title: "Attabotty Flyin", youtubeId: "E0xE65RRKI0", artist: "AttaBotty" },
        { title: "Clejan Intro", youtubeId: "4n1dFs5T4T4", artist: "Clejan" },
      ],
    },
  },
  {
    ...
    recap: {
      ...
      videos: [
        { title: "Live Set", youtubeId: "zYm3g_YUYjE", artist: "Tom Fellenz" },
        { title: "WaveWarZ Battle", youtubeId: "-nx9gZtK8ug", artist: "Stilo World" },
        { title: "Closing Set", youtubeId: "YYyBFasvkuM", artist: "AttaBotty" },
      ],
    },
  },
  {
